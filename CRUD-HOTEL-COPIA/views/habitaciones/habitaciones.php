...
<body>
    ...
    <div class="container crud-container" style="border-top: 4px solid #9b59b6;">
        ...
        <table class="tabla-crud">
            ...
            <tbody>
                ...
                <tr>
                    <td><strong><?php echo htmlspecialchars($h['numero']); ?></strong></td>
                    <td><?php echo htmlspecialchars($h['tipo']); ?></td>
                    <td>$<?php echo number_format($h['precio'], 2); ?></td>
                    <td>
                        <span class="badge <?php echo obternerClaseEstado($h['estado']); ?>">
                            <?php echo $h['estado']; ?>
                        </span>
                    </td>
                    <td>
                ...
                <?php if(count($habitaciones) === 0): ?>
                    <tr><td colspan="5" class="text-center" style="padding: 20px;">No hay habitaciones registradas.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
